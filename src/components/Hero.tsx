...
const Hero = () => {
  ...
  return <section id="hero" className="min-h-screen-dynamic flex flex-col justify-center items-center relative overflow-hidden bg-gradient-to-br from-white to-secondary/30 pt-24 md:pt-28">
      {/* Decorative elements */}
      <div className="absolute inset-0 z-30 overflow-hidden bg-blue-950">
        ...
        <AnimatedElement animation="fade-in" delay={1000} className="mt-12 md:mt-16 relative">
          <div className="relative mx-auto max-w-5xl">
            <div className="aspect-[16/9] rounded-2xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 p-2 md:p-4 shadow-soft-lg glass-card">
              <div className="w-full h-full rounded-lg overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center">
                <div className="relative">
                  <img src="/lovable-uploads/dda80657-f174-4543-a9c9-c0216afa2891.png" alt="Premium blue headphones" className="max-w-xs md:max-w-md lg:max-w-lg mx-auto object-contain transform hover:scale-105 transition-transform duration-500" />
            ...
            <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 glass-card py-3 px-6 text-foreground/90 font-medium">
              {productCategories.map((category, index) => <span key={category.value} className="inline-block">
                  {category.label}
      ...
      <button onClick={scrollToNext} className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce p-2" aria-label="Scroll to next section">
